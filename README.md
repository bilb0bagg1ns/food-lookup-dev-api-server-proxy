...
Article : https://www.fullstackreact.com/articles/using-create-react-app-with-a-server/

MP - The main aspect that this sample demonstrates is how to have the Webpack Dev Server (localhost:3000) talk to API Server (localhost:3001) and avoid the Cross-Origin Resource Sharing (CORS) issue.
